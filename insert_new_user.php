...
$mail->Body =
    'Hello,<br><br>This is an automatic response sent to those who wish to register with Wildfire annotation tool.<br>
    ...
    '<b>Verification Link:</b> 
					   <a href=http://idir.uta.edu/wildfire_annotation_groundtruth/verify_user.php?random_key=' .
    $random_key .
    "&username=" .
    str_replace('"', "", $username) .
    '>
					   http://idir.uta.edu/wildfire_annotation_groundtruth/verify_user.php?random_key=' .
    $random_key .
    "&username=" .
    str_replace('"', "", $username) .
    "</a>" .
    '<br>
					   ...
					   <br>Regards.<br>IDIR Lab Wildfire Project<br>http://idir.uta.edu/wildfire_annotation_groundtruth/<br>contact: idirlabuta@gmail.com';
