					...
					<div>
						...
						<p class='justified_para'>
							If you decide to participate in this research study, this is the list of activities that we will ask you to perform as part of the research:
								...
								8.	If you want to modify the choice you made on a previous pair, click “Modify My Previous Responses”, where you can see all pairs on which you provided annotations, ordered by the timestamps. After your modification, your work quality may become different.
								9.	You will be asked to complete 40 training annotations. Upon submitting your answer to a training example, the website will display a message indicating whether the answer is correct or not and provide a justification for the correct answer. After the first 50 annotations, the “Leaderboard” button will be activated. By clicking it, a pop-up window will show your work quality, total compensation, and where you stand among other participants. Only the first three letters of usernames (instead of full names) will be displayed on the leaderboard. The leaderboard calculation is updated every 15-30 pairs reflecting your new work quality and total compensation.
							...
							Below is a list of tips for improving your work quality. You can find a copy of this list under each annotation pair.
							...
							(6) You may be tempted to pick easy/short claims to work on by clicking "Skip this pair". Keep in mind that our work quality calculation formula has a component that accounts for the length/complexity of claims as well as how many pairs are skipped. We discourage excessive skipping. Nevertheless, if you are not confident about a question, it is still better to skip, because every single mistake will lower your work quality.
							Whenever you make one mistake, our algorithm lowers your work quality, which means you get less points for every pair you have annotated. It takes multiple correct answers to make up for every single mistake and get the work quality back to the previous value. If your current work quality is 0 or very low, it is because our algorithm detected many mistakes in your answers. The best thing to do is to review your answers and modify them if necessary. If your work quality is 0, it might actually be negative internally. If you continue to answer new questions, it will take MANY questions before you can see positive and improving work quality.
							If you have labeled 50-150 pairs, the work quality based on the small sample may not reflect your true work quality. It will become more robust once you have labeled more pairs.
