...
var text_response = {
    "-1": "The tweet author believes the factual claim is false",
    0: "The tweet author believes the factual claim is neither true nor false, or express no stance",
    1: "The tweet author believes the factual claim is true",
    "-2": "Skip this sentence",
    2: "The tweet discusses unrelated topic to the claim",
...
function load_survey_instructions() {
    ...
    container.append(
		...
		\
		<h3><b>&#8226; The tweet author believes the factual claim is true</b></h3> \
		<span class="instruction_example_title">&emsp;Examples of positive tweet-claim pairs:</span><br> \
		<span class="instruction_example_text"> \
			<b>&emsp;&emsp;1. The tweet is capitalizing various words and adding extra ! characters so we can deduce that the tweet author is excited about the news and believe the factual claim is true. They also refer to the arrest as "hitting the motherload" which is slang for finding something that makes you happy.</b><br> \
			&emsp;&emsp;Factual claim: The largest bust in U.S. history’ 412 Muslims arrested from Michigan!<br> \
			&emsp;&emsp;Tweet: 412 Michigan Muslims Arrested ‘LARGEST BUST IN U.S. HISTORY’!! They Hit The MOTHERLOAD! https://freedomdaily.com/?p=360808 via @Freedom_Daily \
		</span><br> \
		<span class="instruction_example_text"> \
			<b>&emsp;&emsp;2. The tweet author is clearly calling for supportive action for the student who was suspended in the claim. This indicates the author believes the situation is real and warrants the attention of "a patriot attorney".</b><br> \
			&emsp;&emsp;Factual claim: "Ohio student suspended for staying in class during National Walkout Day"<br> \
			&emsp;&emsp;Tweet: Tweet: Patriot attorney needed.  Reach out to this family.  Ohio student suspended for staying in class during National Walkout Day https://truepundit.com/ohio-student-suspended-staying-class-national-walkout-day/… \
		</span><br> \
		<span class="instruction_example_text"> \
			<b>&emsp;&emsp;4. The core statement of the claim is that Kamala Harris has been caught in a lie, the tweet author calls Kamala Harris a "moron" for the act of lying because there was no chance she could get away with it due to the fact that "we can look up your lies". This clearly indicates that the tweet author supports the veracity of the claim.</b><br> \
			&emsp;&emsp;Factual claim: KAMALA HARRIS Says Schools in Berkeley Weren’t Integrated When She Was a Kid — But Yearbook Pictures Prove She’s Lying.<br> \
			&emsp;&emsp;Tweet: It is like these morons don\'t know how the Internet works.  We can look up your lies!  Unreal...  KAMALA HARRIS Says Schools in Berkeley Weren\'t Integrated When She Was a Kid -- But Yearbook Pictures Prove She\'s Lying. \
		</span><br> \
		\
		<h3><b>&#8226; The tweet author believes the factual claim is false</b></h3> \
		<span class="instruction_example_title">&emsp;Examples of negative tweet-claim pairs:</span><br> \
		<span class="instruction_example_text"> \
			<b>&emsp;&emsp;1. The tweet author thinks the factual claim worths 4 more Pinocchios and Pinocchios is a misleading rating scale used by Washington Post, a claim contains more misleading claims will receive more Pinocchios. The tweet author also shows fact that the Johnson Amendment is still on the book.</b><br> \
			&emsp;&emsp;Factual claim: We got rid of the Johnson Amendment.<br> \
			&emsp;&emsp;Tweet: That\'s 4 more Pinocchios for @realDonaldTrump as it pertains to his shifting claim that ‘we got rid’ of the Johnson Amendment. Fact: The Johnson Amendment is still a thing. "It\'s still on the books." \
		</span><br> \
		<span class="instruction_example_text"> \
			<b>&emsp;&emsp;2. The tweet author shows that fact that Scott only won by around 1/800 which is far from won by a lot.</b><br> \
			&emsp;&emsp;Factual claim: Rick Scott won and he won by a lot.<br> \
			&emsp;&emsp;Tweet: @realDonaldTrump on Fox News: “Rick Scott won and he won by a lot." Reality: Scott won by 10,033 votes. Out of more than 8 million cast. #AlternativeFacts \
		</span><br> \
		<span class="instruction_example_text"> \
			<b>&emsp;&emsp;3. The tweet author uses sarcasm and jokes about how ridiculous the factual claim is. We can deduce that the tweet author doesn\'t believe ISIS can be distributed in 32 contries.</b><br> \
			&emsp;&emsp;Factual claim: ISIS is in 32 countries.<br> \
			&emsp;&emsp;Tweet: Tweet: "ISIS is in 32 countries."  I think he meant IKEA. \
		</span><br> \
		<span class="instruction_example_text"> \
			<b>&emsp;&emsp;4. The tweet author points out Jennifer Lawrence blamed Trump for 9/11 was a false claim and the meme is fake, so we can deduce the tweet author doesn\'t believe Jennifer Lawrence ever links 9/11 to Trump\'s election.</b><br> \
			&emsp;&emsp;Factual claim: Jennifer Lawrence links 9/11 to Trump\'s election.<br> \
			&emsp;&emsp;Tweet: A New Conspiracy Theory Falsely Claims Jennifer Lawrence Blamed Trump for 9/11. A meme with over 11,000 shares quotes Lawrence as blaming Trump for September 11 because he stole the election, but it\'s totally bogus. \
		</span><br> \
		\
		<h3><b>&#8226; The tweet author believes the factual claim is neither true nor false, or express no stance</b></h3> \
		<span class="instruction_example_title">&emsp;Examples of neutral/no stance tweet-claim pairs:</span><br> \
		<span class="instruction_example_text"> \
			<b>&emsp;&emsp;1. The tweet author requests for how true is the factual claim, we can deduce the tweet author cannot confirm the factual claim is true or false</b><br> \
			&emsp;&emsp;Factual claim: NASA confirms Earth will experience 15 days of darkness In November 2017.<br> \
			&emsp;&emsp;Tweet: Tweet: How true is this????? http://twofeed.org/2017/05/29/nasa-confirms-earth-will-experience-15-days-of-darkness-in-november-2017/ \
		</span><br> \
		<span class="instruction_example_text"> \
			<b>&emsp;&emsp;2. Tweet almost only repeats the content of factual claim and express no stance about whether the media distorted what happened or not.</b><br> \
			&emsp;&emsp;Factual claim: the media distorted what happened with a baby at his rally.<br> \
			&emsp;&emsp;Tweet: DONALD TRUMP Says the MEDIA (reporters) distorted what happened with a baby at his rally.  @cspanwj #tcot \
		</span><br> \
		\
		<h3><b>&#8226; The tweet discusses unrelated topic with regard to the factual claim</b></h3> \
		<span class="instruction_example_title">&emsp;Examples of unrelated tweet-claim pairs:</span><br> \
		<span class="instruction_example_text"> \
			<b>&emsp;&emsp;1. The factual claim is talking about low chances of being killed by refugee\'sterrorist act while the tweet focuses on the fact that two people was killed and ruled as suicide.</b><br> \
			&emsp;&emsp;Factual claim: The chances of being killed by a refugee committing a terrorist act is 1 in 3.6 billion.<br> \
			&emsp;&emsp;Tweet: Tweet: @ItizBiz and @TB_Timesshe was decapitated and ruled a suicide!!???  \
		</span><br> \
		<span class="instruction_example_text"> \
			<b>&emsp;&emsp;2. Even the tweet talks about the Paul Ryan and gun laws, it doesn’t focus on whether Paul Ryan has blocked gun laws or not.</b><br> \
			&emsp;&emsp;Factual claim: Paul Ryan has blocked all action to strengthen our gun laws.<br> \
			&emsp;&emsp;Tweet: Wisconsin students are marching 50 miles to Paul Ryan&apos;s hometown for action on gun laws… https://goo.gl/fb/6SPZtQ http://bitly.com/2sjBBbW \
		</span><br> \
		\
		<h3><b>&#8226; The tweet-claim pair is problematic</b></h3> \
		<span class="instruction_example_title">&emsp;Examples of problematic tweet-claim pairs:</span><br> \
		<span class="instruction_example_text"> \
			<b>&emsp;&emsp;1. Tweet is apparently not in English.</b><br> \
			&emsp;&emsp;Factual claim: Winston Churchill said, "The fascists of the future will call themselves anti-fascists."<br> \
			&emsp;&emsp;Tweet: Links mag alles, denken ze, nee zelfs \'weten\' ze.... #verpletterendeverantwoordelijkheid @jdecleulaer @vanranstmarc \
		</span><br> \
		<span class="instruction_example_text"> \
			<b>&emsp;&emsp;2. Factual claim is a question.</b><br> \
			&emsp;&emsp;Factual claim: Is the Red Cross \'Not Helping California Wildfire Victims\'<br> \
			&emsp;&emsp;Tweet: Don’t forget tomorrow is HAT DAY! Your $2 donation to the Red Cross will help California wildfire victims! \
		</span><br> \
		<span class="instruction_example_text"> \
			<b>&emsp;&emsp;3. Factual claim is a noun phrase.</b><br> \
			&emsp;&emsp;Factual claim: Fake News about the Florida School Shooting.<br> \
			&emsp;&emsp;Tweet: Reading: YouTube\'s crackdown on fake news: Promoting bonkers Florida school shooting conspiracies \
		</span><br><br> \
		<span class="instruction_example_title"> \
			If you are unsure about the answer you can select the “skip sentence” button.<br><br> \
			There will be 40 training questions at the beginning. We will show the correct answer after you submit your response. The actual data collection will start after you are done with the initial 40 training questions. <br><br>\
			Please feel free to use the “Feedback” button (to the right of the browser window) to inform us your suggestions and/or report errors. \
			You can also contact us at <a href="mailto:idirlabuta@gmail.com">idirlabuta@gmail.com</a>. Thanks! \
		</span>\
	</p>'
    );
...
function update_payrate_message(
    ...
    if (is_training == 1) {
        ...
        $("#span_REGION_status").html(
            "Training Question: " +
                ...
                " (remaining " +
                remaining +
                " )<br>This is the training phase. Correct answer and explanation will be shown in this panel. The system only starts to calculate the leaderboard and payrate after the training phase is over."
        );
    ...
    if (ANSWERED_message == null) {
        ...
        $("#span_REGION_status").html(
            "Click 'Leaderboard' to see your pay rate. The leaderboard is enabled after your initial 50 sentences. After that, this message and the leaderboard are updated every 15-30 sentences. </b>See tips for improving your pay rate at the bottom of this page.</b>"
        );
    } else if (ANSWERED_message >= 50) {
        $("#button_leaderboard").prop("disabled", false);
        $("#span_REGION_status").html(
            "Your estimated total payment is $" +
                PAYMENT_message.toString() +
                ". You are paid approximately " +
                QUALITY_message.toString() +
                "&cent; per sentence on average. Your total payment is ranked " +
                RANK_message.toString() +
                " out of " +
                total_message.toString() +
                " participants. Click 'Leaderboard' to see details. This message and the leaderboard are updated every 15-30 sentences. <b>See tips for improving your pay rate at the bottom of this page.</b>"
        );
    } else {
        $("#button_leaderboard").prop("disabled", true);
        $("#span_REGION_status").html(
...
function get_sentence(sentence_id) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.localeCompare("-1") == 0) {
                alert(
                    "No more sentences available for you. Thanks for your participation. We may notify you in case there is a third phase of the data collection."
                );
